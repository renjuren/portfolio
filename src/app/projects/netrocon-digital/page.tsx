      ...
      <main className="bg-black min-h-screen overflow-x-clip">
        ...
        <section className="container-max py-12 md:py-16 -mt-10 md:-mt-16">
          <ScrollReveal delay={0.2} className="w-full max-w-[1024px] mx-auto">
            <div className="relative w-full aspect-[1024/576] overflow-hidden rounded-sm shadow-xl">
              <Image
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <div className="text-body max-w-2xl space-y-6">
                ...
                <div className="bg-white/5 border border-border-default p-6 rounded-sm space-y-4 font-mono text-xs text-white">
                  <div className="flex items-center gap-2">
                    <span className="bg-black text-white px-2 py-0.5 rounded-sm">01</span>
                    <span>Hero Section (Headline with red Highlighter accent + CTAs)</span>
                  </div>
                  <div className="text-text-muted pl-8">↓</div>
                  <div className="flex items-center gap-2">
                    <span className="bg-black text-white px-2 py-0.5 rounded-sm">02</span>
                    <span>Grayscale Client Trust Logo Row</span>
                  </div>
                  <div className="text-text-muted pl-8">↓</div>
                  <div className="flex items-center gap-2">
                    <span className="bg-black text-white px-2 py-0.5 rounded-sm">03</span>
                    <span>Intro / Value Proposition narrative block</span>
                  </div>
                  <div className="text-text-muted pl-8">↓</div>
                  <div className="flex items-center gap-2">
                    <span className="bg-black text-white px-2 py-0.5 rounded-sm">04</span>
                    <span>Benefit / Service details blocks</span>
                  </div>
                  <div className="text-text-muted pl-8">↓</div>
                  <div className="flex items-center gap-2">
                    <span className="bg-black text-white px-2 py-0.5 rounded-sm">05</span>
                    <span>Tiered SaaS-style Pricing Comparison Grid</span>
                  </div>
                  <div className="text-text-muted pl-8">↓</div>
                  <div className="flex items-center gap-2">
                    <span className="bg-black text-white px-2 py-0.5 rounded-sm">06</span>
                    <span>Our Work Process (3-step visual checklist)</span>
                  </div>
                  <div className="text-text-muted pl-8">↓</div>
                  <div className="flex items-center gap-2">
                    <span className="bg-black text-white px-2 py-0.5 rounded-sm">07</span>
            ...
            <div className="lg:col-span-8">
              <div className="text-body max-w-2xl space-y-12">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-white">Colors & Typography</h3>
                  <p>
                  ...
                  <div className="grid grid-cols-4 gap-4 py-4">
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-sm bg-black border border-border-default mb-2"></div>
                      <span className="text-xs font-mono">#000000</span>
                      <span className="text-[10px] text-text-muted">Primary</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-sm bg-white border border-border-default mb-2"></div>
                      <span className="text-xs font-mono">#FFFFFF</span>
                      <span className="text-[10px] text-text-muted">Background</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-sm bg-[#FB1D24] border border-border-default mb-2"></div>
                      <span className="text-xs font-mono">#FB1D24</span>
                      <span className="text-[10px] text-text-muted">Highlighter Red</span>
                    </div>
                    <div className="flex flex-col items-center">
                      <div className="w-12 h-12 rounded-sm bg-[#212529] border border-border-default mb-2"></div>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-white">Signature UI highlighter</h3>
                  <p>
                  ...
                  <div className="bg-black p-8 rounded-sm text-center border border-border-default my-4">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-white">Alternating rhythms & color pop</h3>
                  <p>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-white">Trust bars & tiered pricing</h3>
                  <p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
            ...
            <div className="lg:col-span-8">
              <div className="text-body max-w-2xl space-y-16">
                ...
                {/* Home */}
                <div className="space-y-4">
                  <h3 className="text-xl font-medium text-white">Homepage</h3>
                  <p>
                  ...
                  <div className="relative w-full aspect-[16/10] bg-white/5 border border-border-default rounded-sm overflow-hidden mt-4 shadow-sm">
                    <Image
                      src="/images/netrocon-home.png"
                ...
                {/* Marketing */}
                <div className="space-y-4">
                  <h3 className="text-xl font-medium text-white">Marketing Vertical</h3>
                  <p>
                ...
                {/* Branding */}
                <div className="space-y-4">
                  <h3 className="text-xl font-medium text-white">Branding Vertical</h3>
                  <p>
                ...
                {/* Studio */}
                <div className="space-y-4">
                  <h3 className="text-xl font-medium text-white">ND Studios</h3>
                  <p>
                ...
                {/* Tech Hiring */}
                <div className="space-y-4">
                  <h3 className="text-xl font-medium text-white">Tech Hiring Solutions</h3>
                  <p>
                ...
                {/* Contact */}
                <div className="space-y-4">
                  <h3 className="text-xl font-medium text-white">Contact & Routing</h3>
                  <p>
            ...
            <div className="lg:col-span-8">
              <div className="text-body max-w-2xl space-y-6">
                ...
                <div className="grid grid-cols-2 sm:grid-cols-3 gap-4 pt-6">
                  <div className="relative aspect-[375/812] bg-white/5 border border-border-default rounded-sm overflow-hidden shadow-sm">
                    <Image
                  ...
                  <div className="relative aspect-[375/812] bg-white/5 border border-border-default rounded-sm overflow-hidden shadow-sm hidden sm:block">
                    <Image
